    ...
    <section className={`sectionDiv ${styles.sectionDivStrong}`}>
      <div className="contentWrapper">
        <div className="copyDiv">
          ...
          <ul className="bullets">
        <li>
          <strong>A unique journey for your body and soul.</strong> Each session focuses on what you need most — whether it’s calm, clarity, or gentle growth
        </li>
        <li>
          <strong>Beyond the mat:</strong> I offer mindful habits to balance work, parenting, and self-care. I provide a system, a plan, and simple rituals that can fit into busy mornings or evenings
        </li>
        <li>
          <strong>Backed by neuroscience:</strong> Yoga reduces inflammation, boosts resilience, and rewires your stress responses — proven by recent studies
        </li>
      </ul>
        </div>
      </div>
